...
%o`, message, error2, detail);
  ...
  // app/assets/javascripts/administrate/task/ui/controllers/add_arg_inputs_controller.js
  var add_arg_inputs_controller_default = class extends Controller {
    ...
    connect() {
      ...
      selectField.selectize.on(
        "change",
        (optionValue) => this.handleTaskNameChange(optionValue)
      );
    }
    ...
    #setCurrentArgNames(taskName) {
      this.currentArgNamesValue = this.availableTasksValue[taskName]?.arg_names || [];
    }
  };

  // app/assets/javascripts/administrate/task/ui/controllers/view_source_code_controller.js
  var view_source_code_controller_default = class extends Controller {
  ...
  // app/assets/javascripts/administrate/task/ui/application.js
  var app = Application.start();
  app.register("administrate-task-ui-view-source-code", view_source_code_controller_default);
  app.register("administrate-task-ui-add-arg-inputs", add_arg_inputs_controller_default);
})();
//# sourceMappingURL=/assets/administrate/task/ui/application.js.map
